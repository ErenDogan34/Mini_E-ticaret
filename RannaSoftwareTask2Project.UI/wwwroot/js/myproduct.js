...
$(document).ready(function () {
    var iduser = getUserIdFromToken(token)

    getall()

    function getall() {
        $.ajax({
            url: 'https://localhost:44324/api/Product/GetByIdUser/?id=' + iduser[1],
            type: 'GET',
    ...
    $('#productadd').click(function () {
        window.location.href = '/Product/MyAddProduct';
    });
    ...
    $('#addproduct').click(function () {
        ...
        if (!productName || !productCode || !productPrice || fileImage === 0) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                window.location.href = '/Product/GetMyProduct';
            },
